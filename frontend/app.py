...
# Function used to optain LLM summary of top similar dog breed
...
if uploaded_file is not None:
    ...
    # Save temporarily to disk for feature extraction
    temp_path = "frontend/temp.jpg"
    image.save(temp_path)

    vector = extract_features(temp_path)

    # Perform similarity serach in Qdrant
    ...
    # Generate LLM summary for top match
    top_result = results[0]
    raw_breed = top_result.payload.get("breed", "Unknown")

    # Clean breed name (remove prefix and symbols)
    ...
    for result in results:
        ...
        # Show each similar image with clean caption and score
